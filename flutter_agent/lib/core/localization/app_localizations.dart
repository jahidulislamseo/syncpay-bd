class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'connect_device_desc': 'Connect this Android device to your ZiniPay merchant account.',
      'device_id': 'Device ID',
      ...
      'battery_guidance': 'For reliable SMS processing, allow ZiniPay Agent to run unrestricted in the background.',
    ...
    'bn': {
      ...
      'connect_device_desc': 'আপনার জিনিপে মার্চেন্ট অ্যাকাউন্টের সাথে এই ডিভাইসটি সংযুক্ত করুন।',
      ...
      'battery_guidance': 'নির্ভরযোগ্য এসএমএস প্রসেসিং নিশ্চিত করতে জিনিপে এজেন্টকে ব্যাকগ্রাউন্ডে আনরেস্ট্রিক্টেড চলতে দিন।',
